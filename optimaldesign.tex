...
Using $D_s$-optimality, we can enhance the estimation of any of the three parameters of the model \eref{eq:lorentz3}. For the centre position $x_0$, the optimal measure becomes
\begin{equation}
\xi^*_{x_0} = \left\{
  \begin{array}{c c}
    -0.576 & 0.576 \\
